...
├── flask_cash_back_plataform             # The main python package for the project
...
e.g: `cat flask_cash_back_plataform/VERSION` will get the project version without harming
